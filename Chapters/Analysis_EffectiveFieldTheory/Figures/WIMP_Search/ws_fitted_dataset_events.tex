...
\centering
    \begin{axis}[
        ...
        \addplot[teal, opacity = 0.3]
            table [x=x, y=y]
            {Data/HENR/sr1_ws/sr1_data/b8_band_95.dat};
        \addplot[teal, opacity = 0.1]
            table [x=x, y=y]
...
\end{tikzpicture}
    \caption{SR1 events passing all analysis cuts are shown in the \{S1$_c$,log$_{10}$(S2$_c$)\} space.
             ...
             The 1$\sigma$ and 2$\sigma$ contours are shown for \textit{Flat ER} (blue), \textit{${}^{127}$Xe} (grey), \textit{${}^{37}$Ar} (orange) and \textit{${}^{8}$B} neutrinos (teal).
