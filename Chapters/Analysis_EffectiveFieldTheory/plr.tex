...
In general, the null hypothesis is assumed to be true and is either rejected in favour of the alternative or is failed to be rejected.
The point at which this decision is made is based on statistical probability, so at some confidence level.
...
%Upper limits are set when $\mu$ is disfavoured if a predicted signal rate is significantly different to the observed rate.
