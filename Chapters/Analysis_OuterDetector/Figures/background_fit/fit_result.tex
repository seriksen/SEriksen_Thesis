...
\end{tikzpicture}
    \caption{Result of fit to data.
             ...
             Generally, there is good agreement between the data and fit, but at the extremities, particularly low phd values, there is a large difference, resulting in a $\chi^2$/ndf = 212.6/135.}
