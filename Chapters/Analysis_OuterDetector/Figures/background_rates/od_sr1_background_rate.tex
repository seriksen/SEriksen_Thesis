\begin{figure}[!htbp]
   ...
   \begin{tikzpicture}
        ...
        %xtick=data,
        xtick={2021-11-01 12:00, 2021-12-01 12:00, 2022-01-01 12:00, 2022-02-01 12:00, 2022-03-01 12:00, 2022-04-01 12:00, 2022-05-01 12:00, 2022-06-01 12:00},
        xticklabel style=
        ...
        \addplot[red, smooth, error bar legend,
                 error bars/.cd,
                 y dir=both, y explicit, error bar style={color=black}] table[x=date,y=noise, y error=noise_error] {Data/OD_Backgrounds/background_rates/random_trig_rates.txt};
        \addlegendentry{Noise Cut};
        \addplot[blue, smooth, error bar legend,
                 error bars/.cd,
                 y dir=both, y explicit, error bar style={color=black}] table[x=date,y=100kev, y error=200kev_error] {Data/OD_Backgrounds/background_rates/random_trig_rates.txt};
        \addlegendentry{100 keV};
        \addplot[green, smooth, error bar legend,
                 error bars/.cd,
                 y dir=both, y explicit, error bar style={color=black}] table[x=date,y=200kev, y error=200kev_error] {Data/OD_Backgrounds/background_rates/random_trig_rates.txt};
        \addlegendentry{200 keV};         
         \addplot[black, dashed] coordinates { (2021-12-23,-10)  (2021-12-23,300)};
         \node [rotate=90] at (axis cs:2021-12-25,150) {SR1 start};
         \addplot[black, dashed] coordinates { (2022-04-18,-10)  (2022-04-18,300)};
    ...
    \caption{Rate in OD during and before SR1 data taking on a week-by-week basis using the Random Trigger.
             The SR1 boundary is also shown which ran from 23-12-2021 to 18-04-2022. The gap in data during SR1 was due to a calibration campaign during which different trigger configurations were use, which did not include the Random Trigger.}
