\begin{figure}[]
   ...
   \begin{tikzpicture}
        ...
        \addplot[red, only marks, mark size=1.5pt, error bar legend,
        ...
        \addplot[blue, only marks, mark size=1.5pt, error bar legend,
                 error bars/.cd, error bar style={color=black},
        ...
        \addplot[green, only marks, mark size=1.5pt, error bar legend,
                 error bars/.cd, error bar style={color=black},
        ...
        \addplot+[blue, smooth] table[x=date,y=100kev] {Data/OD_Backgrounds/background_rates/random_trig_rates.txt};
        \addplot+[green, smooth] table[x=date,y=200kev] {Data/OD_Backgrounds/background_rates/random_trig_rates.txt};
