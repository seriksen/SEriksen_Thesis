\begin{figure}[]
  ...
  \end{groupplot}
    \end{tikzpicture}
    \caption{OD Energy Scale and the relation between the observed number of photons and the energy deposited. Analysis by E. Fraser \cite{ewanfraser_thesis_ref}.}
