...
\begin{table}[!htbp]
    ...
    \end{tabular}
    \caption{Th and U decay chain pairs with half-lives within the LZ event window of 4.5ms. See Figure \ref{fig:decay_chains} for the complete Decay Chains.}
...
This was performed using a simple weighted distribution (Equation \ref{eq:OD_xy_position});
