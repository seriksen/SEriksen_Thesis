...
This gives a rate of 90mHz for ${}^{214}Bi \to {}^{214}Po$, which is within 5\% that expected from the 'improved purification' (see \autoref{sec:simulated_od_requirements}).
...
This is again within 5\% of that from the 'improved purification', and so the assumption can be made that this purification was done, and that the estimated rates are correct.
