...
\input{Chapters/Analysis_OuterDetector/Figures/od_sr1_background_rate}
...
\input{Chapters/Analysis_OuterDetector/Figures/od_rate_vs_threshold}
...
\input{Chapters/Analysis_OuterDetector/Figures/od_background_positions}
...
This supports both \autoref{tab:od_expected_rates} and \autoref{fig:OD_estimated_background_rate} ( \autoref{sec:simulated_od_requirements}), where Cavern Gammas are expected to be the largest contributor with the largest contribution coming from the bottom.
...
\input{Chapters/Analysis_OuterDetector/Figures/od_middle_region_phd}
