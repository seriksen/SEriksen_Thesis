...
Unfortunately the accuracy of this simulation has not been determined as that would require a major validation campaign of the optical processes implemented by the author, which would have delayed this thesis, but the speed improvement is a promising result.
