...
\par
An example of the discrimination that is possible between ER and NR in a xenon TPC is shown in \autoref{fig:er_nr_discrimination} for an arbitrary TPC detector.
