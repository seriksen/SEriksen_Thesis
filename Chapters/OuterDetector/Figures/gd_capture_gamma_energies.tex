\begin{figure}[]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{DICEBOX simulation of the energy released by $\gamma$'s from nuclei de-excitation after neutron capture, going from ${}^{155}Gd \xrightarrow{} {}^{156}Gd$ or ${}^{157}Gd \xrightarrow{} {}^{158}Gd$}
