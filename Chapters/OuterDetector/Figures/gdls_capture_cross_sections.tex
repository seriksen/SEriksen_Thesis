\begin{figure}
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
\caption{Capture cross sections for the most significant capture isotopes in the GdLS cocktail. 
A neutron has an increased capture probability if its energy is close to that of the isotope energy. 
