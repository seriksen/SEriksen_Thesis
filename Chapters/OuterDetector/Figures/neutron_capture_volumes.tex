...
\end{axis}  
\end{tikzpicture}  
    \caption{Fraction of background neutrons expected to get captured in each detector volume for all background neutrons and for neutrons that scatter once in the TPC Xenon.}
