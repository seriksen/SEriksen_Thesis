...
Given that the neutrons are being captured in the GdLS, the measured capture time from all mediums (except GdLS) will be lower than in Table \ref{tab:medium_neutron_capture_time}. 
