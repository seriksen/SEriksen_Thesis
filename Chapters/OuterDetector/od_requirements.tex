...
\begin{table}[!htbp]
    ...
    \begin{tabular}{c|c|c|c|c|c|c|c}
        \multirow{2}{*}{Material or Component} & \multirow{2}{*}{Total Mass (kg)} & \multicolumn{6}{c}{Estimated Activity (mBq/kg)}      \\ 
                    &        & ${}^{238}U_{e}$ & ${}^{238}U_{l}$ & ${}^{232}Th_{e}$ & ${}^{232}Th_{l}$ & ${}^{60}Co$ & ${}^{40}K$ \\ \hline
        HandiFoam\textsuperscript{\textregistered}   & 15 & 123 & 51 & 31 & 21 & 0 & 62 \\
        ...
        Tyvek                                        & 10  & 6.0  & 2.2  & 0     & 0     & 0 & 5100 \\
        OCV (and all parts)                          & 1020 & 0.11 & 0.04 & 0.03  & 0.02  & 0 & 0.16 \\
        ...
        SAT titanium plates                          & 308 (each) & 0.11 & 0.04 & 0.03  & 0.02  & 0 & 0.16 \\
...
Additionally, during construction the OCV was exposed to cavern air for a prolonged period of time which undoubtedly will have increased the rate of surface contaminants.
The most significant other decay of note is ${}^{60}Co$ from the OCV with an expected activity of XXX .
