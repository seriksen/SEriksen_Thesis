...
\centering
  \begin{groupplot}[%view={0}{90},
    ...
    \nextgroupplot[
            ...
            minor y tick num=4,
            grid=major,
            legend style = { column sep = 10pt, legend columns = -1, legend to name = CommonLegend,}]
            \addplot+[green, smooth, mark=none]
                    table [x=Time,y=Efficiency]
  ...
  \end{groupplot}
   \node at ($(group c2r1) - (group c1r1) + (-0.5cm, 6.0cm)$) {\ref{CommonLegend}};
\end{tikzpicture}
    ...
    \nextgroupplot[
        ...
        \nextgroupplot[
            ...
            \addplot[red, only marks, 
                    ...
                    {Data/Neutron_Efficiency/Simulation/amli_neutron_eff_100kev_error_bars.dat};
    \end{groupplot}
     \node at ($(group c2r1) - (group c1r1) + (-0.5cm, 5.0cm)$) {\ref{CommonLegend}};
\end{tikzpicture}
